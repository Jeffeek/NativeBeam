...
Write-Host "  NativeBeam Build Script" -ForegroundColor Cyan
Write-Host "======================================" -ForegroundColor Cyan
Write-Host ""
...
dotnet clean NativeBeam.slnx -c $Configuration
...
dotnet restore NativeBeam.slnx
...
dotnet build NativeBeam.slnx -c $Configuration --no-restore
...
if (-not $SkipTests) {
    ...
    dotnet test NativeBeam.slnx -c $Configuration --no-build --verbosity normal
